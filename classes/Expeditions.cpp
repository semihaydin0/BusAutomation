					...
					ExpeditionsAGAIN6:
						...
						ExpeditionsAGAIN7:
							...
							case 2:
								...
								break;
							default:
								cout << "Hatalı giriş yaptınız.Tekrar seçiniz." << endl;
	...
	if (Check.is_open())
	{
		...
		while (!Check.eof())
		{
			...
			if (LoggedWorkerID == workerid_)
			{
				...
				{
					Check.close();
					cout << "Düzenlemek istediğiniz seferin ID bilgisini giriniz :";
					cin >> ExpeditionsID_;
					...
					if (ExCheck.is_open())
					{
						...
						while (!ExCheck.eof())
						{
							...
							ExpeditionsAGAIN1:
								...
								cout << "Lütfen düzenlemek istediğiniz kısmı seçiniz.\n1-Tarih\n2-Saat\n3-Fiyat\nSeçiminiz :";
								cin >> editselec;
